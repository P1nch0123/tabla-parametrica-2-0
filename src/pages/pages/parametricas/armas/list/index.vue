      ...
      <html>
        ...
        <body>
          <div class="header-container">
            <div class="membrete">
              <div class="membrete-item">Comando General del Ejército</div>
              <div class="membrete-item">Departamento I - Personal</div>
              <div class="membrete-item">Bolivia</div>
...
'<head>' +
    ...
    '<style>' +
        ...
        '.membrete-item { margin-bottom: 4px; }' +
        '.title-section { flex: 2; text-align: center; }' +
        '.main-title { font-size: 16px; font-weight: bold; color: #2c3e50; margin: 0; text-transform: uppercase; }' +
        '.date-info { margin-top: 8px; font-size: 9px; color: #666; }' +
        'table { width: 100%; border-collapse: collapse; border: 1px solid #4f4f4f; margin: 10px 0; font-size: 9px; }' +
        'th, td { border: 1px solid #4f4f4f; padding: 6px 4px; text-align: left; vertical-align: top; }' +
        'th { background-color: #4f4f4f; color: white; font-weight: bold; text-align: center; }' +
        'tr:nth-child(even) { background-color: #f9f9f9; }' +
        ...
        '.col-abreviatura { width: 15%; }' +
        '.col-posicion { width: 12%; text-align: center; }' +
...
'<body>' +
    '<div class="header-container">' +
        '<div class="membrete">' +
            '<div class="membrete-item"><strong>Institución:</strong><br>Comando General del Ejército</div>' +
            '<div class="membrete-item"><strong>Departamento:</strong><br>Departamento I - Personal</div>' +
            '<div class="membrete-item"><strong>País:</strong><br>Bolivia</div>' +
            '<div class="membrete-item"><strong>Sistema:</strong><br>SPRODA V2.0</div>' +
        '</div>' +
        '<div class="title-section">' +
            '<h1 class="main-title">REPORTE DE ARMAS</h1>' +
            '<div class="date-info">' +
                '<div>Fecha: ' + reportDate + '</div>' +
                '<div>Hora: ' + reportTime + '</div>' +
            '</div>' +
        '</div>' +
    '</div>' +
...
'<head>' +
    ...
    '<style>' +
        ...
        '@media print {' +
            ...
            'table { width: 100%; border-collapse: collapse; border: 1px solid #4f4f4f; margin: 10px 0; font-size: 9px; }' +
            'th, td { border: 1px solid #4f4f4f; padding: 6px 4px; text-align: left; vertical-align: top; }' +
            'th { background-color: #4f4f4f !important; color: white !important; font-weight: bold; text-align: center; }' +
            'tr:nth-child(even) { background-color: #f9f9f9; }' +
            '.footer { margin-top: 15px; font-size: 8px; text-align: center; border-top: 1px solid #ccc; padding-top: 8px; display: flex; justify-content: space-between; }' +
        '}' +
        ...
        'table { width: 100%; border-collapse: collapse; border: 2px solid #4f4f4f; margin: 15px 0; font-size: 11px; }' +
        'th, td { border: 1px solid #4f4f4f; padding: 8px 6px; text-align: left; vertical-align: top; }' +
        'th { background-color: #4f4f4f; color: white; font-weight: bold; text-align: center; }' +
        'tr:nth-child(even) { background-color: #f9f9f9; }' +
...
const printTable = async () => {
  try {
    ...
    htmlParts.push('<h3>COMANDO GENERAL DEL EJÉRCITO<br>DEPARTAMENTO I - PERSONAL<br>BOLIVIA</h3>')
    htmlParts.push('<h4>REPORTE DE ARMAS</h4>')
    htmlParts.push('<p>Fecha: ' + new Date().toLocaleDateString('es-MX', { year: 'numeric', month: 'long', day: 'numeric' }) + '</p>')
    htmlParts.push('<p>Hora: ' + new Date().toLocaleTimeString('es-MX') + '</p>')
    htmlParts.push('</div>')
    ...
    htmlParts.push('<p>Generado por el Sistema SPRODA V2.0 - Página 1</p>')
    htmlParts.push('</div>')
...
001;Fusil de Asalto AK-47;AK47;1;Activo
002;Pistola Glock 19;G19;2;Activo
003;Rifle de Francotirador Barrett M82;BM82;3;Activo
004;Escopeta Remington 870;R870;4;Activo
005;Subfusil MP5;MP5;5;Activo
006;Granada de Fragmentación M67;M67;6;Activo
007;Lanzagranadas M79;M79;7;Inactivo
008;Ametralladora M60;M60;8;Activo
009;Pistola Beretta 92FS;B92;9;Activo
010;Fusil M16A4;M16;10;Activo
011;Revólver Smith & Wesson .357;SW357;11;Activo
012;Escopeta Mossberg 500;M500;12;Inactivo
013;Subfusil UZI;UZI;13;Activo
014;Rifle de Asalto M4 Carbine;M4;14;Activo
015;Pistola Colt 1911;C1911;15;Activo`
        ...
        <div class="d-flex gap-4 align-center flex-wrap">
          ...
          <VMenu>
            ...
            <VList>
              ...
              <VListItem
                prepend-icon="tabler-printer"
                title="Imprimir con formato PDF"
                @click="exportToPDF"
              />
              <VListItem
      ...
      >
        ...
        >
          <VIcon
            ...
            size="16"
          />
          {{ areAllCurrentPageSelected ? 'Deseleccionar Todos' : 'Seleccionar Todos' }}
        </VBtn>
      </div>
...
001;Fusil de Asalto AK-47;AK47;1;Activo
002;Pistola Glock 19;G19;2;Activo
003;Rifle de Francotirador;RF;3;Inactivo
004;Granada de Fragmentación;GF;4;Activo</pre>
          </VCard>
        </div>
