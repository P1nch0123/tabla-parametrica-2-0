...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'basic-pdf-test': RouteRecordInfo<'basic-pdf-test', '/basic-pdf-test', Record<never, never>, Record<never, never>>,
    ...
    'components-dialogs-arma-info-edit-dialog': RouteRecordInfo<'components-dialogs-arma-info-edit-dialog', '/components/dialogs/ArmaInfoEditDialog', Record<never, never>, Record<never, never>>,
    ...
    'examples-pdf-direct-example': RouteRecordInfo<'examples-pdf-direct-example', '/examples/pdf-direct-example', Record<never, never>, Record<never, never>>,
    'examples-pdf-file-example': RouteRecordInfo<'examples-pdf-file-example', '/examples/pdf-file-example', Record<never, never>, Record<never, never>>,
    'examples-pdf-url-example': RouteRecordInfo<'examples-pdf-url-example', '/examples/pdf-url-example', Record<never, never>, Record<never, never>>,
    ...
    'pages-parametricas-armas-list': RouteRecordInfo<'pages-parametricas-armas-list', '/pages/parametricas/armas/list', Record<never, never>, Record<never, never>>,
    'pages-parametricas-armas-list-index-report-pdf': RouteRecordInfo<'pages-parametricas-armas-list-index-report-pdf', '/pages/parametricas/armas/list/index_report_pdf', Record<never, never>, Record<never, never>>,
    'pages-parametricas-armas-list-index-cero': RouteRecordInfo<'pages-parametricas-armas-list-index-cero', '/pages/parametricas/armas/list/index-cero', Record<never, never>, Record<never, never>>,
    ...
    'test-pdf': RouteRecordInfo<'test-pdf', '/test-pdf', Record<never, never>, Record<never, never>>,
